export default function Card({title}:{title:string}) {
    return(
        <div className={"card max-w-md flex flex-col bg-[#0F0F0F] pb-2 rounded-b-[15px]"}>
            ...
            <button className={"show mx-auto flex p-2 border-3 w-3/4 h-[40px] border-[#78df71] text-[#78df71] font-medium items-center justify-center rounded-lg"}>Sprawdź</button>
