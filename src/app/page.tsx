    ...
    return (
        <div className={"h-auto"}>
            <header className="h-screen flex relative flex-col bg-[#1c1e22] overflow-hidden shadow-xl ">
                ...
                <nav className="w-full flex relative z-10 flex-row gap-6 justify-end p-6 text-xl font-medium text-[#78df71]">
                    <Link href="/">Projekty</Link>
                    <Link href="/">Kontakt</Link>
                    <Link href="/">O Mnie</Link>
                </nav>
                <div className="flex flex-grow flex-col items-center justify-center relative z-10 w-full px-2">
                <div className={"about-me relative mx-auto text-center mt-"}>
                    <div className={"text-5xl font-medium"}>{"<MATEUSZ SERAFIN/>"}</div>
                    <span className={"p-4"}>
